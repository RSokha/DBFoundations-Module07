...
-- 2023-08-21,RSokha,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_RSokha')
	 Begin 
	  Alter Database [Assignment07DB_RSokha] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_RSokha;
	 End
	Create Database Assignment07DB_RSokha;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_RSokha;
...
--Drop View: DROP VIEW vProductInventories 
...
--Drop View: DROP VIEW vCategoryInventories
...
--Dropping View: DROP VIEW vProductInventoriesWithPreviousMonthCounts; 
...
AS
	...
	InventoryCount,
	PreviousMonthCount,
	InventoryCountVsPreviousMonthCountKPI = ISNULL 
		(CASE
...
AS
	RETURN SELECT
		...
		InventoryCount,
		PreviousMonthCount,
		InventoryCountVsPreviousMonthCountKPI
	FROM vProductInventoriesWithPreviousMonthCountsWithKPIs
	WHERE InventoryCountVsPreviousMonthCountKPI = @KPIValue;
